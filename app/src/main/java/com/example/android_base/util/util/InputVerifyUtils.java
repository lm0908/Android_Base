...
package com.example.android_base.util.util;

import android.content.Context;
import android.view.View;
import android.widget.EditText;

import com.example.android_base.util.view.animation.ViewAnimationUtils;
import com.example.android_base.util.widget.ToastUtils;
